    ...
    <div className="flex-1 overflow-y-auto bg-bg px-8 py-7">
      ...
      <div className="max-w-[520px]">
        <Section title="Preferences">
          <Row label="Language" hint="Interface and response language (also selectable in top header)">
            <select value={language} onChange={e => setLanguage(e.target.value)}
              ...
              {languages.map(l => <option key={l.code} value={l.name}>{l.native} ({l.name})</option>)}
            </select>
          </Row>
